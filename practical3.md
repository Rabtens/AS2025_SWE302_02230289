...
[Full `shipping_v2_test.go` code would be included here]

### Appendix B: Implementation Code

[Full `shipping_v2.go` code would be included here]

### Appendix C: Test Execution Logs

[Detailed verbose test output would be included here]
